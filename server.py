...
CACHE_TTL_SECONDS = int(os.getenv("CACHE_TTL_SECONDS", "86400"))  # 24h cache
...
SHOPS = [
    ...
    {"id": "topocentras", "name": "Topo centras",   "flag": "🇱🇹", "url": "topocentras.lt"},
    {"id": "elesen",      "name": "Elesen",         "flag": "🇱🇹", "url": "elesen.lt"},
...
def build_prompt(query: str, shops: list) -> str:
    ...
    return f"""SmartShop AI. Find prices for: "{query}"
Shops: {shop_str}

Search: "{query} kaina", "{query} price amazon.de", "{query} pigiau"

Return ONLY JSON:
{{"product_name":"","product_emoji":"","ai_verdict":"BUY|WAIT|SKIP|OK","verdict_label":"Pirkti dabar|Palaukti|Vengti|Normalu","verdict_reason":"","ai_summary":"","buy_recommendation":"","deal_score":75,"price_min":0,"price_max":0,"price_avg":0,"results":[{{"shop":"","flag":"","url":"","price":0,"currency":"EUR","in_stock":true,"delivery":"","deal_score":80,"rating":0,"review_count":0,"notes":"","is_best_value":false,"is_cheapest":false,"is_top_rated":false,"why_recommended":"","source":"web_search"}}]}}

Rules: verdict in Lithuanian, skip shops with no price found, mark is_cheapest/is_best_value/is_top_rated. JSON ONLY."""
